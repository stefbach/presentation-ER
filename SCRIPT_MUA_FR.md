...
## 2 — LE FONDATEUR, EN DEUX MOTS (0:15 → 0:45)

Je m'appelle Stéphane Bach. Je suis médecin — spécialiste en santé publique. Trente ans à voir comment fonctionnent vraiment les systèmes de santé. J'ai dirigé des cliniques, publié des algorithmes avec Aix-Marseille, réalisé deux exits.

En 2019, j'ai choisi Maurice — pour y rester. Ma femme est mauricienne, mes enfants grandiront ici. Ce projet n'est pas une stratégie de sortie : c'est une vision de long terme, pour Maurice, pour l'Afrique et pour l'océan Indien.

---

## 3 — DDS, PRODUCTEUR DE LOGICIELS IA (0:45 → 1:20)

DDS n'est pas une agence IA. C'est un producteur de logiciels IA.

Trois produits en production — TIBOK, Lexora, Axon — construits par une équipe de sept Mauriciens, formés en douze mois, qui, augmentés par leurs agents IA, ont la force de soixante-dix. Zéro talent importé.
...
## 5 — TIBOK, LA PLATEFORME (1:50 → 2:45)
...
## 6 — CADRE LÉGAL (2:45 → 3:55)

La téléconsultation n'est pas un débat juridique. C'est un fait accompli — depuis bientôt trente ans.

Depuis 1997, l'Organisation mondiale de la santé la définit comme un acte médical à part entière. La France la rembourse depuis 2018. Les États-Unis depuis le Medicare Act, généralisé aux cinquante États. Le Royaume-Uni, l'Allemagne, l'Australie, le Canada, la Suisse l'ont intégrée à leur droit commun.

Et à Maurice ? Le Medical Council Act de mille neuf cent quatre-vingt-dix-neuf n'impose aucune condition de présence physique.

L'acte médical se définit par la qualité de son auteur — un médecin inscrit — et par sa nature clinique. Pas par le canal technique.
...
## 7 — L'ÉCOSYSTÈME TIBOK (3:55 → 5:25)

Découvrons l'écosystème Tibok.

Dix outils — gravitant autour d'une intelligence centrale.

La téléconsultation vidéo, sans rendez-vous. L'ordonnance numérique, signée, transmise à la pharmacie. Le réseau de pharmacies qui livre jusqu'à Rodrigues. Les analyses biologiques et d'imagerie. Le suivi des maladies chroniques. La gestion famille. SilentCheck pour la prévention. Le second avis médical. Et le contrôle de pertinence.

Au cœur de tout : la Medical Intelligence. Elle ne se limite pas à un module — elle intervient à tous les niveaux. Sur chaque consultation. Sur chaque ordonnance. Sur chaque examen.
...
Au cœur de Tibok, il y a ce qui fait notre signature : la Medical Intelligence.

Nous combinons les meilleurs grands modèles de langage du marché — Claude, GPT, Gemini, Mistral — avec un système RAG, *Retrieval-Augmented Generation*, adossé à plus de soixante mille références issues des plus grandes sociétés savantes mondiales.

Recommandations de l'Organisation mondiale de la santé. Protocoles de la Société européenne de cardiologie. Référentiels de l'American Heart Association. Guidelines NICE, INSERM, HAS, FDA.

Chaque consultation, chaque ordonnance, chaque rapport produit sur Tibok est verrouillé par ce socle scientifique.

L'IA ne remplace pas le médecin. Elle l'augmente. Elle vérifie. Elle suggère. Elle alerte. Et c'est le médecin qui garde, toujours, la décision finale.

Et à chaque cas traité, le système apprend. An un, c'est bon. An trois, meilleur que bien des médecins.

---

## 9 — SILENTCHECK : LA PRÉVENTION ACTIVE (6:45 → 8:05)

Notre innovation phare s'appelle SilentCheck.

C'est un outil de stratification du risque cardiovasculaire, basé sur le Score BSD — pour Bach, Sampol, Dignat-George.

Une science fondée sur quatre millions de patients suivis dans cinquante-deux pays. Cinquante-trois références scientifiques de premier plan, publiées dans le New England Journal of Medicine, The Lancet, JACC, Circulation. Soixante-neuf mille six cent douze individus inclus dans la cohorte de validation. Onze profils ethniques avec sept multiplicateurs adaptés à la population mauricienne.

Quinze biomarqueurs analysés. Trois bilans selon le niveau de risque.

SilentCheck détecte cinq à dix ans à l'avance les anomalies que les symptômes ne révèlent pas encore.
...
## 10 — SECOND AVIS MÉDICAL (8:05 → 8:45)

Pour les pathologies complexes, Tibok propose le Second Avis Médical.

Le dossier complet du patient — anamnèse, ordonnance, imagerie, biologie, antécédents — est intégralement revérifié par notre dispositif IA et RAG médical.

Les grands modèles de langage analysent le dossier dans sa globalité. Le moteur RAG le confronte à nos soixante mille références. Et un médecin Tibok valide le rapport final.
...
## 14 — VISION RÉGIONALE : MAURICE, PUIS L'AFRIQUE (11:30 → 11:55)
