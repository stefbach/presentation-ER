...
(function () {
  ...
  const C = {
    ...
    coral: '#E0735F',
    txt: '#EAF1FB',
    dim: 'rgba(206,219,240,0.52)',
    faint: 'rgba(200,214,236,0.16)'
  };
  ...
  function envelope(local, dur, inD = 0.55, outD = 0.55) {
    let o = 1;
    if (local < inD) o = Easing.easeOutCubic(clamp(local / inD, 0, 1));else if (local > dur - outD) o = 1 - Easing.easeInCubic(clamp((local - (dur - outD)) / outD, 0, 1));
    return o;
  }
  function useScene() {
    const s = useSprite();
    return {
      ...s,
      o: envelope(s.localTime, s.duration)
    };
  }
  function fr(n, dec = 0) {
    const f = Number(n).toFixed(dec);
    let [a, b] = f.split('.');
    a = a.replace(/\B(?=(\d{3})+(?!\d))/g, '\u202F');
    return b ? a + ',' + b : a;
  }
  function ev(local, at, dur, ease = Easing.easeOutCubic) {
    return ease(clamp((local - at) / dur, 0, 1));
  }
  ...
  function FX({
    ...
    const t = useTime();
    const gx = 50 + Math.sin(t * 0.18) * 14,
      gy = 38 + Math.cos(t * 0.13) * 10;
    const hx = 50 + Math.cos(t * 0.11) * 20,
      hy = 64 + Math.sin(t * 0.09) * 12;
    const map = {
      gold: '224,169,59',
      teal: '39,176,190',
      coral: '224,115,95',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        position: 'absolute',
        inset: 0,
        background: `linear-gradient(180deg,#0B1E3C 0%,${C.navy} 58%,#07152A 100%)`
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          height: sz,
          borderRadius: sz,
          background: `rgba(${col},${tw * intensity})`,
          boxShadow: `0 0 ${4 * sz}px rgba(${col},${0.5 * tw * intensity})`
        }
      });
    }), Array.from({
      length: 7
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          height: sz,
          borderRadius: sz,
          background: `rgba(${col},${0.16 * intensity})`,
          filter: 'blur(2px)'
        }
      });
    }), /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          textAlign: align,
          opacity: op * op,
          fontFamily: italic ? FS : font,
          fontStyle: italic ? 'italic' : 'normal',
          fontWeight: isFocus ? weight : weight,
          fontSize: size,
          lineHeight: 1.18,
          color: col,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          color: isAcc ? accentColor : color,
          opacity: p,
          transform: `translateY(${(1 - p) * 26}px)`,
          willChange: 'transform,opacity',
          maxWidth: align === 'center' ? 'none' : '24ch',
          marginInline: align === 'center' ? 'auto' : 0,
          textWrap: 'balance'
        }
      }, ln);
    }), sub && (() => {
      const p = ev(localTime, 0.35 + lines.length * 0.22, 0.7);
      return /*#__PURE__*/React.createElement("div", {
        style: {
          marginTop: 34,
          fontFamily: FD,
  ...
  function Photo({
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        overflow: 'hidden',
        opacity: introT,
        transform: `translateY(${(1 - introT) * 22}px)`,
        boxShadow: shadow ? '0 30px 70px rgba(0,0,0,0.5)' : 'none',
        outline: ring ? '1px solid rgba(255,255,255,0.10)' : 'none',
        willChange: 'transform,opacity'
      }
      ...
      style: {
        ...
        filter: grayIn ? `grayscale(${clamp(1 - hold, 0, 1)})` : 'none',
        display: 'block'
      }
    }));
  }
  ...
  function Stat({
    ...
    }, prefix, fr(val, dec), suffix), label && /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: FD,
        fontWeight: 600,
        fontSize: 21,
  ...
  function Chip({
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        color: C.txt,
        opacity: p,
        transform: `translateY(${(1 - p) * 14 + by}px) scale(${0.96 + 0.04 * p})`
      }
  ...
  function Bar({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontSize: 26,
        color,
        opacity: ev(localTime, at + 0.3, 0.5),
        fontVariantNumeric: 'tabular-nums'
      }
    }, prefix, fr(value * t, dec), suffix), /*#__PURE__*/React.createElement("div", {
      style: {
        width: '100%',
        height: h,
        display: 'flex',
  ...
  function Panel({
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        boxShadow: '0 14px 36px rgba(0,0,0,0.34),inset 0 1px 0 rgba(255,255,255,0.06)',
        borderRadius: 18,
        padding: '26px 30px',
        opacity: p,
  ...
  function Card3D({
    ...
    const acc = accent ? accentSide === 'left' ? {
  ...
  function PhotoTile({
    ...
    const tx = Math.sin(k * 0.12) * 1.1,
      ty = Math.cos(k * 0.1) * 0.9;
    return /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        left: x,
      ...
      style: {
        position: 'absolute',
        inset: 0,
        background: 'linear-gradient(180deg, rgba(10,26,51,0.04) 0%, rgba(10,26,51,0.5) 64%, rgba(10,26,51,0.92) 100%)'
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: 0,
        background: `linear-gradient(120deg, ${color}26, transparent 55%)`,
        mixBlendMode: 'screen'
      }
  ...
  function FlowLink({
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      strokeLinecap: "round"
    }), dot && grow > 0.98 && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("circle", {
      cx: dx,
      cy: dy,
      r: 11,
      fill: color,
  ...
  function Phone({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        inset: 0,
        borderRadius: w * 0.16,
        background: 'linear-gradient(160deg,#1c2c4a,#0a1526)',
        border: '1px solid rgba(255,255,255,0.16)',
        boxShadow: `0 44px 95px rgba(0,0,0,0.6), 0 0 70px ${C.blue}33`,
        padding: w * 0.03
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        borderRadius: w * 0.13,
        overflow: 'hidden',
        background: 'linear-gradient(170deg,#0c1e3c,#081427)',
        display: 'flex',
        flexDirection: 'column',
        gap: h * 0.022,
        padding: `${h * 0.05}px ${w * 0.085}px`
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
      ...
      style: {
        marginTop: 'auto',
        background: `linear-gradient(120deg, ${C.teal}33, ${C.blue}22)`,
        border: `1px solid ${C.teal}66`,
        borderRadius: w * 0.07,
        padding: `${h * 0.028}px ${w * 0.07}px`,
        opacity: ev(localTime, at + 1.3, 0.7)
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: FD,
