...
(function () {
  ...
  const SCENES_B = [/* ---------- 5 · TIBOK, THE PLATFORM ---------- */
  {
    dur: 40,
    hue: 'blue',
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      ...
      size: 50,
      weight: 700,
      lines: ['Not a consultation app.', 'A layer of medical intelligence.'],
      accentIdx: [1],
      accentColor: C.blue
    ...
    }, ['20+ physicians — Medical Council of Mauritius', 'FR · EN · Kreol', '7 days a week'].map((c, i) => /*#__PURE__*/React.createElement(Chip, {
      key: i,
      at: 0.6 + i * 0.16,
      color: C.teal
  ...
  }, /* ---------- 6 · THE LEGAL FRAMEWORK ---------- */
  {
    ...
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      act: "Legal framework",
      title: "An established fact for 30 years",
      color: C.gold
    }), /*#__PURE__*/React.createElement(Statement, {
      x: 120,
      y: 158,
      size: 54,
      weight: 700,
      lines: ['What is not forbidden', 'is permitted.'],
      accentIdx: [1],
      accentColor: C.gold
  ...
  }, /* ---------- 7 · THE TIBOK ECOSYSTEM ---------- */
  {
    ...
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      act: "The ecosystem",
      title: "Ten tools, one central intelligence"
    ...
    }, "AI agents that never sleep"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        justifyContent: 'center',
        gap: 14,
      ...
      at: 1.4,
      color: C.gold
    }, "Chronic-follow-up agent — WhatsApp reminders, alerts"), /*#__PURE__*/React.createElement(Chip, {
      at: 1.55,
      color: C.gold
    }, "Prevention agent — cohorts × guidelines"), /*#__PURE__*/React.createElement(Chip, {
      at: 1.7,
      color: C.gold
  ...
  }, /* ---------- 8 · MEDICAL INTELLIGENCE & RAG ---------- */
  {
    ...
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      ...
      title: "LLM + RAG — the scientific foundation",
      color: C.teal
    }), /*#__PURE__*/React.createElement(Statement, {
      x: 120,
      y: 158,
      size: 50,
      weight: 700,
      lines: ['AI does not replace the doctor.', 'It augments them.'],
      accentIdx: [1],
      accentColor: C.teal
    }), /*#__PURE__*/React.createElement(IntelCore, null), /*#__PURE__*/React.createElement(Narration, {
      lines: ['At the heart of Tibok is our signature: Medical Intelligence.', 'The best large language models — Claude, GPT, Gemini, Mistral —', 'combined with a RAG system anchored to more than sixty thousand', "references from the world's leading medical societies: the WHO,", 'the European Society of Cardiology, the American Heart Association,', 'NICE, INSERM, HAS, the FDA. Every consultation, every prescription', 'is locked to this foundation. AI does not replace the doctor.', 'It augments them. It checks, it suggests, it alerts —', 'and the doctor always keeps the final decision.'],
      x: 960,
      width: 1560,
      align: "center",
      y: 928,
  ...
  }, /* ---------- 9 · SILENTCHECK ---------- */
  {
    ...
    hue: 'gold',
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      act: "Active prevention",
      title: "SilentCheck · BSD Score",
      color: C.gold
    }), /*#__PURE__*/React.createElement(Statement, {
      x: 120,
      y: 150,
      size: 50,
      weight: 700,
      lines: ['Detect 5 to 10 years in advance', 'what symptoms keep silent.'],
      accentIdx: [1],
      accentColor: C.gold
  ...
  }, /* ---------- 10 · THE MEDICAL SECOND OPINION ---------- */
  {
    ...
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      act: "Second opinion",
      title: "A second reading, fully sourced"
    }), /*#__PURE__*/React.createElement(Statement, {
      x: 120,
      y: 158,
      size: 50,
      weight: 700,
      lines: ['Automated quality control,', 'before every costly act.'],
      accentIdx: [1],
      accentColor: C.blue
  ...
  }, /* ---------- 11 · RELEVANCE CONTROL ---------- */
  {
    ...
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      ...
      size: 50,
      weight: 700,
      lines: ['From ex-post control on paper', 'to native, real-time control.'],
      accentIdx: [1],
      accentColor: C.green
    }), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, ['Time-stamping', 'Electronic signature', 'Video traceability', 'Relevance analysis'].map((c, i) => /*#__PURE__*/React.createElement(Chip, {
      key: i,
      at: 0.5 + i * 0.14,
      color: C.green
  ...
  }, /* ---------- 12 · THE PROOF: SWAN ---------- */
  {
    ...
    node: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ActTag, {
      act: "The proof",
      title: "The principle is validated",
      color: C.green
    }), /*#__PURE__*/React.createElement(Statement, {
      x: 120,
      y: 150,
      size: 54,
      weight: 700,
      lines: ['This model is not a promise.', 'It is already under way.'],
      accentIdx: [1],
      accentColor: C.green
    ...
    }, "With Swan, signature is under way — the first major insurer to ", /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.green,
        fontWeight: 800
      }
    }, "commit"), " to reimbursing consultations and prescriptions made on TIBOK."))), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        top: 588,
        left: 0,
  ...
  function LegalTimeline() {
    ...
    const ph = [['1997', 'WHO', 'A medical act in its own right', C.blue], ['2018', 'France', 'Reimbursed by national insurance', C.blue], ['Medicare Act', 'United States', 'Extended to all fifty states', C.blue], ['Ordinary law', 'UK · DE · AU · CA · CH', 'Written into national law', C.teal], ['1999', 'Mauritius — Medical Council Act', 'No requirement of physical presence', C.gold]];
    const W = 316,
      gap = 24,
  ...
  function ToolsGrid() {
    ...
    const mods = [['Teleconsultation', 'Video, no appointment needed', C.blue, 'video'], ['Digital prescription', 'Signed, sent to the pharmacy', C.teal, 'rx'], ['Pharmacy network', 'Delivery as far as Rodrigues', C.gold, 'pill'], ['Lab tests & imaging', 'Biology and radiology integrated', C.teal, 'lab'], ['Chronic follow-up', 'Blood pressure · diabetes · weight, via WhatsApp', C.gold, 'heart'], ['Family management', 'All your relatives, one account', C.blue, 'family'], ['SilentCheck', 'Prevention & early detection', C.gold, 'shield'], ['Second opinion', 'File reviewed by AI + physician', C.blue, 'second'], ['Relevance control', 'Every act verified before the expense', C.green, 'control'], ['Medical Intelligence', 'At the core — on every consultation, prescription, test', C.coral, 'brain']];
    const gap = 18,
      W = 402;
    return /*#__PURE__*/React.createElement("div", {
      style: {
  ...
  function IntelCore() {
    ...
    }, "The best LLMs"), llms.map((l, i) => /*#__PURE__*/React.createElement(NodeChip, {
      key: i,
      label: l[0],
      icon: "◆",
      x: 330,
    ...
    }, "scientific references"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: FD,
        fontWeight: 400,
        fontSize: 15,
  ...
  function SilentCheckViz() {
    ...
    const bars = [['of heart disease develops without symptoms for 10 years', 80, C.coral], ['of complications are avoidable with early detection', 85, C.green]];
    return /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: 0
      ...
      size: 72,
      color: C.blue,
      label: "references — NEJM · Lancet · JACC",
      align: "center",
      at: 0.7
    }), /*#__PURE__*/React.createElement(Stat, {
      to: 69612,
  ...
  function FinalScene() {
    ...
    }, "Let us build", /*#__PURE__*/React.createElement("br", null), "tomorrow’s standard —", /*#__PURE__*/React.createElement("br", null), "for Mauritius, Africa", /*#__PURE__*/React.createElement("br", null), "and the Indian Ocean.")), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        right: 120,
        top: 300,
